...
function alarm(){
        ...
        if(morningValue==hourValue){
            ...
            messageImage.style.cssText="background-image:url('./img/morning.png')"
        }
        ...
        if(lunchValue==hourValue){
            ...
            messageImage.style.cssText="background-image:url('./img/afternoon.png')"
        }
        ...
        if(napValue==hourValue){
            ...
            messageImage.style.cssText="background-image:url(./img/lunch.png);"
        }
        ...
        if(nightValue==hourValue){
            ...
            messageImage.style.cssText="background-image:url(./img/night.png);"
        }
}
/* function for alarm */
...
function def(){
    ...
    message.textContent="TAKE SOME REST !";
    alarmMessage.textContent="NO ALARMS AS OF YET"   
    messageImage.style.cssText="background-image:url(./img/default.png);"
}
/* function for default display */